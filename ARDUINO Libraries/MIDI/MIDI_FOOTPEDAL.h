...
#ifndef LIB_MIDI_FOOTPEDAL_H_
#define LIB_MIDI_FOOTPEDAL_H_
...
#define FOOTPEDAL_USE_SERIAL_PORT Serial3     // Change the number (to Serial1 for example) if you want
 ...
 */
class MIDI_FOOTPEDAL_Class {
	
	
public:
	// Constructor and Destructor
	MIDI_FOOTPEDAL_Class();
	~MIDI_FOOTPEDAL_Class();
...
extern MIDI_FOOTPEDAL_Class MIDI_FOOTPEDAL;

#endif // LIB_MIDI_FOOTPEDAL_H_
