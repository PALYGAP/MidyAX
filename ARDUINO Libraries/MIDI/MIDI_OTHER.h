...
#ifndef LIB_MIDI_OTHER_H_
#define LIB_MIDI_OTHER_H_
...
#define OTHER_USE_SERIAL_PORT Serial3     // Change the number (to Serial1 for example) if you want
...
extern MIDI_OTHER_Class MIDI_OTHER;

#endif // LIB_MIDI_OTHER_H_
