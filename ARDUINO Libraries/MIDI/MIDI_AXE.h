...
#ifndef LIB_MIDI_AXE_H_
#define LIB_MIDI_AXE_H_
...
#define AXE_FX_USE_SERIAL_PORT  Serial1     // Change the number (to Serial1 for example) if you want
                                            // to use a different serial port for MIDI I/O.
                                            // EF_MODIF : AXE-FX is on Serial1
...
extern MIDI_AXE_Class MIDI_AXE;

#endif // LIB_MIDI_AXE_H_
